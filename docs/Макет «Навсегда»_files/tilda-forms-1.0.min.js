...
var FORMS_API_FIELD = {
    ...
    RATING: "rs",
    CHECKBOX: "cb",
    FILE: "uw",function _await$1(t, e, r) {
    return r ? e ? e(t) : t : (t && t.then || (t = Promise.resolve(t)), e ? t.then(e) : t)
}
var FORMS_API_FIELD = {
    EMAIL: "em",
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
        ...
        for (var e = t_forms__getElement(t), r = e.querySelectorAll(".js-tilda-rule"), o = [], n = !0, a, i = t_forms__getConditionCheckHandler(e).isHiddenByCondition, s = 0; s < r.length; s++) {
            ...
            if (!i(l)) {
                var c = !!parseInt(l.getAttribute("data-tilda-req") || 0, 10),
                    ...
                    h = e.getAttribute("data-formcart");
                ...
                var b = !w.length && !v.length,
                    ...
                    A = e.querySelectorAll('[name="' + g + '"]:checked').length;
                if ((w.length && !E || E && A) && (n = !1), c && (b || E && !A)) p.type.push("req");
                    ...
                    switch (u) {
                        ...
                        case "chosevalue":
                            ...
                            break;
                        case "promocode":
                            "y" !== h || !v.length || !window.tcart || window.tcart.promocode && window.tcart.prodamount_discountsum || p.type.push("promocode");
                            break;
                        case "deliveryreq":
        ...
        if ("y" === h) {
            ...
            if (T && window.tcart.total < window.tcart_mincntorder)(p = {
                obj: {},
                type: []
        ...
        for (var f = 0; f < e.length; f++)
            if (e[f] && e[f].obj) {
                ...
                for (var p = 0; p < e[f].type.length; p++) {
                    var w = e[f].type[p],
                        v = t_forms__getMsg(w);
                    u = "", (l = r.querySelector(".js-rule-error-" + w)) ? l.textContent && l.innerText || !v || -1 !== d.indexOf(v) ? (u = l.textContent || l.innerText, -1 === d.indexOf(u) && (d = d + '<p class="t-form__errorbox-item">' + u + "</p>")) : d = d + '<p class="t-form__errorbox-item">' + v + "</p>" : v && -1 === d.indexOf(v) && (d = d + '<p class="t-form__errorbox-item">' + v + "</p>"), i && (!u && t_forms__getMsg(w + "field") ? u = t_forms__getMsg(w + "field") : v && (u = v), u && a && (c = a.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(c, (function(t) {
            ...
            if (Array.prototype.forEach.call(y, (function(t) {
                ...
                if (g && g.length) {
                    var h, b = '.t1093 .t-popup[data-tooltip-hook="' + g[g.length - 1] + '"]',
    ...
    //     document.body.insertAdjacentHTML("beforeend", i), window.removeEventListener("message", checkVerifyTildaCaptcha), window.addEventListener("message", checkVerifyTildaCaptcha), document.getElementById("tildaformcaptchabox").focus()
        ...
        if (o) {
            t_removeClass(document.body, "t-body_success-popup-showed"), /iPhone|iPad|iPod/i.test(navigator.userAgent) && !window.MSStream && window.tildaForm.unlockBodyScroll(), t_fadeOut(o);
    ...
    }, window.tildaForm.showSuccessPopupNew = function(t, e, r) {
        var o = "tildaformsuccesspopup-new",
            n = document.body,
            a = document.getElementById(o);
        if (!a) {
            var i = t_forms__drawNewSuccessPopup();
            n.insertAdjacentHTML("beforeend", i), (a = document.getElementById(o)).addEventListener("click", (function(t) {
                var e;
                ((t = t || window.event).target || t.srcElement) === this && window.tildaForm.closeSuccessPopup()
            }));
            var s = a.querySelector(".t-form-success-popup__close-icon");
            s && s.addEventListener("click", window.tildaForm.closeSuccessPopup);
            var l = a.querySelector(".t-form-success-popup__button");
            l && l.addEventListener("click", window.tildaForm.closeSuccessPopup), n.addEventListener("keydown", (function(t) {
                var e = (t = t || window.event).keyCode || t.which;
                "Escape" !== t.key && 27 != e || window.tildaForm.closeSuccessPopup()
            }))
        }
        var c = {
                title: document.getElementById("tildaformsuccesspopuptitle-new"),
                text: document.getElementById("tildaformsuccesspopuptext-new"),
                button: document.getElementById("tildaformsuccesspopupbtn-new")
            },
            u = {
                title: t_forms__getMsg("success_title"),
                text: t_forms__getMsg("success_text"),
                button: t_forms__getMsg("success_btn")
            };

        function d(t, e, r) {
            t && (t.classList.toggle("t-form-success-popup_hidden", !r), r && e && (t.innerHTML = e))
        }
        e || t ? (d(c.title, e, !!e), d(c.text, t, !!t)) : (d(c.title, u.title, !0), d(c.text, u.text, !0)), c.button && d(c.button, r || u.button, !0), t_fadeIn(a), t_addClass(n, "t-body_success-popup-showed"), /iPhone|iPad|iPod/i.test(navigator.userAgent) && !window.MSStream && setTimeout((function() {
            window.tildaForm.lockBodyScroll()
        }), 500)
        ...
        if (inputItsGood || form.insertAdjacentHTML("beforeend", '<div style="position: absolute; left: -5000px; bottom: 0; display: none;"><input type="text" name="form-spec-comments" value="Its good" class="js-form-spec-comments" tabindex="-1" /></div>'), 2 === formType || !formType && formKey) {
            ...
            var formUrl = "https://script.google.com/macros/s/AKfycbyqLqpiI4m5a7ZB1KCmZP57SozlrgsscqGehKroDdcapMusQo6MaozXBBzNvxl0MWSa/exec" //"https://" + window.tildaForm.endpoint + "/procces/",
...
function t_forms__showSuccessbox(t) {
    ...
    var r = t_forms__getMsg("success"),
        o = e.getAttribute("data-success-message");
    o ? e.innerHTML = o : e.textContent && e.innerText || o || !r || (e.innerHTML = r);
    var n = e.innerHTML,
        a = t_forms__isNewSuccessBox(t);
    if (!o && a && (n = ""), a) {
        var i = e.getAttribute("data-success-title"),
            s = e.getAttribute("data-success-btn");
        e.innerHTML = '\n\t\t\t<div class="t-form__successbox-title">' + (i || "") + '</div>\n\t\t\t<div class="t-form__successbox-text">' + n + '</div>\n\t\t\t<div class="t-form__successbox-btn">' + (s || "") + "</div>\n\t\t"
    }
    return t_forms__parseVariables(e).finally((function() {
        if ("y" === t.getAttribute("data-success-popup")) {
            var r = e.querySelector(".t-form__successbox-title"),
                o = e.querySelector(".t-form__successbox-text"),
                i = e.querySelector(".t-form__successbox-btn"),
                s = r ? r.innerHTML : "",
                l = o ? o.innerHTML : "",
                c = i ? i.innerHTML : "",
                u;
            return n = a ? l : e.innerHTML, void(!!t.closest(".t396") ? window.tildaForm.showSuccessPopup(e.innerHTML) : window.tildaForm.showSuccessPopupNew(n, s, c))
        }
...
function t_forms__drawNewSuccessPopup() {
    return '\n\t\t<div class="t-form-success-popup t-form-success-popup_new" style="display:none;" id="tildaformsuccesspopup-new" \n\t\t\trole="dialog"\n\t\t\taria-modal="true" \n\t\t\ttabindex="-1" \n\t\t\taria-label="Success"\n\t\t>\n\t\t\t<div class="t-form-success-popup__wrapper"> \n\t\t\t\t<button type="button" class="t-form-success-popup__close-icon" aria-label="Закрыть диалоговое окно">\n\t\t\t\t\t<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">\n\t\t\t\t\t\t<path fill="#000" fill-rule="evenodd" d="M7 5.863 1.138 0 0 1.138 5.862 7 0 12.862 1.137 14 7 8.137 12.863 14 14 12.862 8.138 7 14 1.138 12.863 0 7.001 5.863Z" clip-rule="evenodd" opacity=".4"/>\n\t\t\t\t\t</svg>\n\t\t\t\t</button>\n\t\t\t\t\n\t\t\t\t<svg class="t-form-success-popup__content-icon" xmlns="http://www.w3.org/2000/svg" width="41" height="41" viewBox="0 0 41 41" fill="none">\n\t\t\t\t\t<path fill="#30C546" fill-rule="evenodd" d="M24.428 2.188a6.109 6.109 0 0 0-8.431 0 6.109 6.109 0 0 1-4.604 1.675 6.109 6.109 0 0 0-6.458 5.42 6.109 6.109 0 0 1-2.45 4.242 6.109 6.109 0 0 0-1.464 8.303 6.109 6.109 0 0 1 .851 4.824 6.109 6.109 0 0 0 4.216 7.302 6.109 6.109 0 0 1 3.752 3.149 6.109 6.109 0 0 0 7.923 2.883 6.108 6.108 0 0 1 4.898 0 6.109 6.109 0 0 0 7.923-2.883 6.109 6.109 0 0 1 3.753-3.15 6.109 6.109 0 0 0 4.215-7.3 6.109 6.109 0 0 1 .851-4.825 6.109 6.109 0 0 0-1.464-8.303 6.109 6.109 0 0 1-2.45-4.242 6.109 6.109 0 0 0-6.458-5.42c-1.701.108-3.37-.5-4.603-1.675Zm4.231 15.476a1.47 1.47 0 0 0-2.02-2.138l-9.504 8.983-3.77-3.563a1.47 1.47 0 1 0-2.02 2.138l4.78 4.517a1.47 1.47 0 0 0 2.02 0l10.514-9.937Z" clip-rule="evenodd"/>\n\t\t\t\t</svg>\n\n\t\t\t\t<div class="t-form-success-popup__title t-title" id="tildaformsuccesspopuptitle-new">\n\t\t\t\t\tThank You!\n\t\t\t\t</div>\n\n\t\t\t\t<div class="t-form-success-popup__text t-text" id="tildaformsuccesspopuptext-new">Thank You!</div>\n\n\t\t\t\t<button type="button" class="t-form-success-popup__button t-btn" id="tildaformsuccesspopupbtn-new">\n\t\t\t\t\tDone\n\t\t\t\t</button>\n\t\t\t</div>\n\t\t</div>'
}
    UPLOADCARE_FILE: "uc",
    DELIVERY: "dl",
    SAVE_CONTACT: "sf",
